...
const SignupPage: React.FC = () => {
  ...
  return (
    <>
      <h2 className="text-2xl font-light text-center mb-2">Join TradeZy</h2>
      <p className="text-sm text-gray-600 text-center mb-6">Shop wholesale from thousands of brands</p>
      ...
      <p className="text-center mt-6 text-sm text-gray-600">
        ...
        {' · '}
        <Link to="/brands" className="text-black font-medium hover:underline">
          Sell on TradeZy
        </Link>
      </p>
